...
export const csdnArticlePublisher = async (data) => {
    console.log('csdnArticlePublisher data', data);
    ...
    const formElement = {
        ...
        submitButtons: 'button.btn-outline-danger',
        submitButtonText: '发布博客',
    }
    ...
    const autoFillContent = async (contentData) => {
        ...
        const titleTextarea = await observeElement(formElement.title) as HTMLElement;
