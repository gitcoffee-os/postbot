...
export const juejinArticlePublisher = async (data) => {
    console.log('juejinArticlePublisher data', data);
    ...
    const formElement = {
        title: '.editor-header input[placeholder="输入文章标题..."]',
        editor: '.bytemd-editor div.CodeMirror-code[role="presentation"]',
        submitButtons: 'button.xitu-btn',
        submitButtonText: '发布',
    }
