 ...
 */
export const jianshuArticlePublisher = async (data) => {
    console.log('jianshuArticlePublisher data', data);
    ...
    const formElement = {
        createArticleButton: 'i.fa-plus-circle',
        title: 'input[type="text"]:not([placeholder="请输入文集名..."])',
        ...
        // nextButtonText: '下一步',
        confirmButtons: 'a[data-action="publicize"]',
        confirmButtonText: '发布文章',
    }
    ...
    const createArticleButton = () => {
        const createArticleButton = document.querySelector(formElement.createArticleButton);
       
        console.log('createArticleButton', createArticleButton);
       
        createArticleButton.dispatchEvent(new Event('click', {
            bubbles: true,
            cancelable: true
        }));
    }
    ...
    await observeElement(formElement.createArticleButton);

    await createArticleButton();
