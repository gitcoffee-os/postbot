 ...
 */
export const doubanArticlePublisher = async (data) => {
    console.log('doubanArticlePublisher data', data);
    ...
    const formElement = {
        ...
        nextButtonText: '下一步',
        confirmButtons: 'div.editor-popup-setting-submit button[type="submit"]',
