...
export const getMomentPublishUrl = () => {
    const token = getToken();
    // const ticket = getTicket();
    // const username = getUsername();
    const publishUrl = `https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit_v2&action=edit&isNew=1&type=77&createType=8&token=${token}&lang=zh_CN`;
    return publishUrl;
}

export const weixinMomentPublisher = async (data) => {
    console.log('weixinMomentPublisher data', data);
    ...
    const formElement = {
        ...
        imageUpload: 'div.js_upload_btn_container input[type="file"]',
    ...
    console.log('images', processedData.images);
