...
export const getLizhiAlbumPublishUrl = (albumId) => {
    if (!albumId) {
        // TODO
    }
    const publishUrl = `https://nj.lizhi.fm/static/newsite/#/content/upload`;
    console.log('publishUrl', publishUrl);
    return publishUrl;
}

export const lizhiAudioPublisher = async (data) => {
    console.log('lizhiAudioPublisher data', data);
