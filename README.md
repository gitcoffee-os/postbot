...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">PostBot 内容同步助手 v1.0.8</h1>
<h4 align="center">
	一款开源的多平台内容同步分发生产力工具。
	<br />
...
<br />
![postbot-publisher](https://postbot.exmay.com/docs/images/postbot_publisher.png?v=1.0.8)
<br />
![postbot-editor](https://postbot.exmay.com/docs/images/postbot_editor.png?v=1.0.8)
<br />
...
###  [🌍 多平台](https://postbot.exmay.com/docs/media)
   - 覆盖微信/微博/今日头条/小红书/知乎/百家号/抖音/快手/哔哩哔哩（B站）等国内主流媒体平台，可轻松扩展兼容 X（Twitter）、Facebook、Instagram、TikTok、YouTube、LinkedIn 等国际媒体平台。
### 🚀 一键发布
   - 一次编辑排版、一键同步至多平台自动发布。
